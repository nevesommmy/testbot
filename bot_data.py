...
admin_id = [7023319781]  # Сюда вставляем всех админов через запятую [123123, 837148, 12312] или только одного [123]
verification = True  # True - если хотите поставить проверку на человека
token = "6996408806:AAG6qkIwuVaHUYRzT-jYd1GM4q2OMCjV94k"  # токен бота

vxod_worker = "/воркер"

shop_name = "BullShop"  # название шопа
admin_chat = "whatama"  # username админа для связи без @
feedback_link = "https://"  # ссылка на канал с отзывами

qiwi = "mqdodik"  # телефон киви или ник
card = "1234123412341234"  # номер карты
bitcoin = "0xoi213kj453123"  # адрес битка
# ___________________________________________________________________

any_data = {"city_key": {"Иваново": "moskow_zone",
